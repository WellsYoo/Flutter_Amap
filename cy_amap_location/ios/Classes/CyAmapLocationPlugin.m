#import "CyAmapLocationPlugin.h"
#import <AMapFoundationKit/AMapFoundationKit.h>
#import <AMapLocationKit/AMapLocationKit.h>

@interface CyAmapLocationPlugin()<AMapLocationManagerDelegate>
...
@implementation CyAmapLocationPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"cy_amap_location"
                                     binaryMessenger:[registrar messenger]];
    CyAmapLocationPlugin* instance = [[CyAmapLocationPlugin alloc] init];
...
-(void)getLocation:(BOOL)withReGeocode result:(FlutterResult)result{
    ...
    self.completionBlock = ^(CLLocation *location, AMapLocationReGeocode *regeocode, NSError *error){
        ...
        NSMutableDictionary* md = [[NSMutableDictionary alloc]initWithDictionary: [CyAmapLocationPlugin location2map:location]  ];
        if (regeocode)
        {
            [md addEntriesFromDictionary:[CyAmapLocationPlugin regeocode2map:regeocode]];
            md[@"code"] = @0;
            md[@"success"] = @YES;
        }
        else
