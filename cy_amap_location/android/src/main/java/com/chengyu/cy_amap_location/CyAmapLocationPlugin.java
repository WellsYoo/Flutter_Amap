package com.chengyu.cy_amap_location;
...
/** CyAmapLocationPlugin */
public class CyAmapLocationPlugin implements MethodCallHandler,FlutterPlugin {
  ...
  private CYAMapLocationListener cyaMapLocationListener;
  //备份至
  private boolean onceLocation;

//  public  CyAmapLocationPlugin(Registrar registrar, MethodChannel channel) {
...
//    final MethodChannel channel = new MethodChannel(registrar.messenger(), "cy_amap_location");
//    channel.setMethodCallHandler(new CyAmapLocationPlugin(registrar,channel));
//  }
...
//      result.success(this.startLocation(this));
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "cy_amap_location");
  ...
  public class CYAMapLocationListener implements AMapLocationListener {
